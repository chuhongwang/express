...
<div class="auth-item-view">
    ...
    <div class="row">
        <div class="col-sm-5">
            ...
            <select multiple size="18" class="form-control list"  data-target="avaliable"></select>
        </div>
        <div class="col-sm-1">
            <br><br>
        ...
        <div class="col-sm-5">
            ...
            <select multiple size="18" class="form-control list" data-target="assigned"></select>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-5">
