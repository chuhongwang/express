 ...
 * then the themed version for a view file `@app/views/site/indexTest.php` will be
 * `@app/themes/basic/site/indexTest.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/indexTest.php` or
 * `@app/themes/basic/site/indexTest.php`. The former has precedence over the latter if both files exist.
 *
