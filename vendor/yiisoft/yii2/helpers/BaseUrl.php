...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /indexTest.php?r=site/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /indexTest.php?r=site/index&param1=value1#name
     ...
     *
     * ```php
     * // /indexTest.php?r=site%2Findex
     * echo Url::toRoute('site/index');
     *
     * // /indexTest.php?r=site%2Findex&src=ref1#name
     ...
     *
     * // /indexTest.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     ...
     *
     * // /indexTest.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /indexTest.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /indexTest.php?r=post%2Fview&id=100&src=google
     ...
     *
     * ```php
     * // indexTest.php?r=post%2Findex&PostSearchForm%5Bid%5D=100&PostSearchForm%5Bsrc%5D=google
     * echo Url::current([
