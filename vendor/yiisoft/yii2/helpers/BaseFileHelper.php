...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/indexTest.php` but not `views/controller/indexTest.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `indexTest.php` but not `views/start/indexTest.php`.
