...
$url = [
    0 => [
        'label' => '开发管理',
        'url' => '/development-management/index'
    ],
    1 => [
        'label' => '接入流程',
        'url' => '/open-platform/work-flow'
    ],
    2 => [
        'label' => 'API文档',
        'url' => '/api-document'
    ...
    3 => [
        'label' => '常见问题',
        'url' => '/open-platform/common-problem'
    ],
    4 => [
        'label' => '安全设置',
        'url' => '/safe-management'
...
<section class="wrap clearfix">
    ...
    <div class="page-body">
        <div class="aside col-2 fl" asidecurrent="" id="aside">
            <dt><a href="<?= Yii::$app->getHomeUrl() ?>" style="color:black">个人中心</a></dt>
            <dd>
                <ul class="nav">
                    <?php
                    foreach ($url as $v) {
                        $class = '/' . Yii::$app->request->PathInfo == $v['url'] ? 'current' : '';
                        $style = '/' . Yii::$app->request->PathInfo == $v['url'] ? 'style = "width:200px"' : 'style = "width:177px"';
                        echo '<li id="side-menu-index"><a ' . $style . '  href="' . $v["url"] . '" data="" id="_allmoney"
                                                class="' . $class . '" reload="true">' . $v["label"] . '<i
                                    class="icon-arr"></i></a></li>';
                    }
                    ?>
                </ul>
            </dd>
        </div><!-- ngView: undefined -->
    </div>
</section>
/**
 * Created by PhpStorm.
